    ...
    def geoprocsseing(pointgdf):
        ...
        def f(x):
            try:
                ...
                return None
        polymean = joined.dissolve(["NAME_MAHAL","landuse","type"],f,False)
...
class propertyModelAdmin(admin.ModelAdmin):
    list_display = ["case_id","landuse","type", "area", "price", "mahale", "date_time"]
    search_fields = ["case_id","landuse","type", "area", "price", "mahale","exp", "date_time"]
